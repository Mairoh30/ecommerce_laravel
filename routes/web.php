...
// Admin Route
    ...
    Route::get('/admin/distributors', [DistributorController::class, 'index'])->name('admin.distributors');
    Route::get('/admin-logout', [AuthController::class, 'admin_logout'])->name('admin.logout');
   
    Route::get('/admin/distributors', 'DistributorController@index')->name('admin.distributor.index');
   ...
   Route::put('/admin/distributor/update/{id}', [DistributorController::class, 'update'])->name('distributor.update');
